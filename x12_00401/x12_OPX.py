...
class OPX(Segment):
    ...
    Description:
        To provide receiving educational institution or agency with information concerning the placement criteria and/or status of the student in a program
    
    Source:
        https://www.kasoftware.com/schema/edi/x12/00401/segments/OPX/
    """
