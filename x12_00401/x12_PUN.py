...
class PUN(Segment):
    ...
    Description:
        To transmit identifying numbers and other basic data relating to the Motor Carrier Pick-up Notification transaction set
    
    Source:
        https://www.kasoftware.com/schema/edi/x12/00401/segments/PUN/
    """
