...
class E24(Segment):
    ...
    Description:
        To provide the detail information related to the sequence of the data elements in a segment for the electronic form of the X12 standards
    
    Source:
        https://www.kasoftware.com/schema/edi/x12/00401/segments/E24/
    """
