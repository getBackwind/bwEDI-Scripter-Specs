...
class CD1(Segment):
    ...
    Source:
        https://www.kasoftware.com/schema/edi/x12/00501/segments/CD1/
    """
    ...
    BillOfLadingDispositionCode: X12ID = element(
        name="CD112",
        description="Bill of Lading Disposition Code",
        mandatory=True,
        min_length=2,
        max_length=2,
    )

    BillOfLadingDispositionCode2: Optional[X12ID] = element(
        name="CD113",
        description="Bill of Lading Disposition Code",
        min_length=2,
        max_length=2,
    ...
    BillOfLadingDispositionCode3: Optional[X12ID] = element(
        name="CD114",
        description="Bill of Lading Disposition Code",
        min_length=2,
        max_length=2,
