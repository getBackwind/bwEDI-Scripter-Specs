...
class GR(Segment):
    ...
    Source:
        https://www.kasoftware.com/schema/edi/x12/00501/segments/GR/
    """
    ...
    GuaranteeAmountReductionCode: Optional[X12ID] = element(
        name="GR22",
        description="Guarantee Amount Reduction Code",
        min_length=2,
        max_length=2,
    )
