...
class CF2(Segment):
    ...
    Description:
        To identify the freight bill number, net amount due, and other basic data related to the freight bill such as date of pick-up
    
    Source:
        https://www.kasoftware.com/schema/edi/x12/00401/segments/CF2/
    """
